...
# Specifically, this function works at scaling the image.
...
def geo_scaling(input_directory, scale_factor, output_directory):
    ...
    for filename in picture_files:
        ...
        # Perform scaling without interpolation (INTER_NEAREST)
        ...
        # Define the output filename with "_scaling" added
        output_filename = f"{file_base_name}_scaling{file_extension}"
...
geo_scaling(input_directory, 50, output_directory)
